...
# However, urlMoreInfo,referendumThresholdPercent,afterVoteMessageHtml,disableListWhoVoted,adminDuringElectionOK,headerLocation,footerLocation,additionalVotesCsvDirectory are optional fields which need not be created
